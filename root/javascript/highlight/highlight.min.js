...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `css` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("python",e)})();/*! `kotlin` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
